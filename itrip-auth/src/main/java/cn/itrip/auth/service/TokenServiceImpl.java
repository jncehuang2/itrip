...
//			sb.append(user.getUserCode() + "-");
	...
	public void setValues(String key, String values) {
		redisAPI.set(key,values);
	}

	@Override
	public void setExValues(String key, String values,int exTime) {
		redisAPI.setEx(key,values,exTime);
	}

	@Override
	public Object getValues(String key) {
		return JSON.parseObject(redisAPI.get(key),Object.class);
	}

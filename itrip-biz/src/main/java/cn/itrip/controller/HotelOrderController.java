    ...
    public Dto<RoomStoreVO> getPreOrderInfo(@RequestBody ValidateRoomStoreVO validateRoomStoreVO, HttpServletRequest request) {
        ...
        try {
            ...
            if (EmptyUtils.isEmpty(validateRoomStoreVO.getHotelId())) {
                ...
                hotel = hotelService.getItripHotel((validateRoomStoreVO.getHotelId()).intValue());
                ...
                BeanUtils.copyProperties(validateRoomStoreVO,roomStoreVO);
        ...
        if (null != currentUser) {
            ...
            try {
                ...
                if (null != hotelOrder) {
                    ...
                    BeanUtils.copyProperties(hotelOrder,itripPersonalHotelOrderVO);
                    //查询预订房间的信息
